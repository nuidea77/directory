...
- Зураглал: Leaflet + CARTO Voyager суурь зураг (OSM өгөгдөл, POI icon-гүй цэвэрхэн
  хэв маяг, түлхүүргүй). Их ачаалалтай болбол `.env`-ийн `VITE_MAP_TILES`-ээр өөр
  tile үйлчилгээ рүү солино. «Зам заах» нь Google Maps руу гардаг.
