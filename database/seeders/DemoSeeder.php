...
class DemoSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $samples = [
            ...
            ['org' => 'Клуб 8 ХХК', 'name' => 'Клуб 8 Билльярд', 'slug' => 'club-8-billiard', 'category' => 'entertainment-3', 'sub' => 'Билльярд', 'district' => 'Сүхбаатар', 'address' => 'Бага тойруу 44', 'phone' => '99447788', 'price' => '₮₮', 'verified' => true,
                'amenities' => ['Пул ширээ', 'Снукер ширээ', 'Орос билльярд', 'Цагаар түрээслэнэ', 'Тэмцээн зохион байгуулна', 'Баар', 'Зогсоол'],
                'payments' => ['Storepay', 'Pocket'],
                'desc' => '12 ширээтэй билльярдны клуб. Пул, снукер, орос билльярд. Долоо хоног бүр тэмцээнтэй, дасгалжуулагчтай.'],
